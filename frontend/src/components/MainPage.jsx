...
const MainPage = () => {
    return (
        <div className="bg-gradient-to-b from-[#101212] to-[#08201D] h-full relative" >
            <section className="relative min-h-screen pt-20 pb-5 sm:pt-18 sm:pb-16 lg:pb-24">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
                    <div className="max-w-xl mx-auto text-center">
                        <h1 className="text-4xl font-bold sm:text-6xl">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Get Loan Clarity Before You Apply </span>
                        </h1>
                        <p className="mt-5 text-base text-white sm:text-xl">Use our AI-powered predictor to check your loan approval chances — fast, accurate, and secure. No paperwork. No guesswork.</p>

                        <Link to="/register" title="" className="inline-flex items-center px-6 py-4 mt-5 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700" role="button">
                        ...
                        <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                            <div className="flex items-center">
                                ...
                                <p className="ml-3 text-sm text-white">Instant Loan Eligibility Check</p>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="ml-3 text-sm text-white">Powered by AI, Tailored to You</p>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <p className="ml-3 text-sm text-white">Private. Secure. Zero Spam.</p>
                            </div>
